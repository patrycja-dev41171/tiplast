...
const props = defineProps({
    ...
    statuses: { type: Array, default: () => [{ id: 'awaiting_payment', label: 'Oczekuje na płatność' }, { id: 'pending_approval', label: 'Do zatwierdzenia' }, { id: 'processing', label: 'W przygotowaniu' }, { id: 'shipped', label: 'Wysłane' }, { id: 'completed', label: 'Zrealizowane' }, { id: 'cancelled', label: 'Anulowane' }, { id: 'partial_refund', label: 'Częściowy zwrot' }, { id: 'full_refund', label: 'Całkowity zwrot' }] },
