...
export default defineEventHandler(async (event) => {
   ...
   try {
      await transporter.sendMail({
         ...
         to: order.email,
         subject: `Zamównienie ${order.order_number} zostało anulowane`,
